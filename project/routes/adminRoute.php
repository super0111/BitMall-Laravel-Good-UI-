...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware('auth:admin')->group(function(){
        ...
        Route::get('/send/notification',                 [AdminController::class,'notification'])->name('notifications')->middleware('permission:transactions');
        Route::post('/send/notification',                 [AdminController::class,'sendNotification'])->name('sendNotification')->middleware('permission:transactions');
        ...
        Route::get('user/blog',       [BlogController::class,'userBlogs'])->name('blog.user.index')->middleware('permission:manage blog');
        Route::get('user/blog/edit/{blog}',       [BlogController::class,'userBlogEdit'])->name('blog.user.edit')->middleware('permission:blog edit');
        //==================================== Manage Currency ==============================================//
        ...
        // Manage Reviews
        Route::get('/manage-reviews',[ManageReviewController::class,'index'])->name('review.index')->middleware('permission:manage user');
        Route::post('/add-review',[ManageReviewController::class,'store'])->name('review.store')->middleware('permission:manage user');
        Route::post('/update-review/{review}',[ManageReviewController::class,'update'])->name('review.update')->middleware('permission:manage user');
        Route::delete('/delete-review/{review}',[ManageReviewController::class,'destroy'])->name('review.destroy')->middleware('permission:manage user');
        
        Route::get('/best-sellers',[ManageUserController::class,'bestSeller'])->name('user.best_seller')->middleware('permission:manage user');
        Route::post('/best-seller',[ManageUserController::class,'addBestSeller'])->name('user.add_best_seller')->middleware('permission:manage user');
        Route::delete('/delete-best-seller/{user}',[ManageUserController::class,'removeBestSeller'])->name('review.remove_best_seller')->middleware('permission:manage user');
