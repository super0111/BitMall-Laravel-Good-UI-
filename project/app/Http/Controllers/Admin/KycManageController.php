...
class KycManageController extends Controller
{
    ...
    public function rejectKyc(Request $request,$id)
    {
        ...
        @email([
            ...
            'message' => 'Salute Ninja,<br /><br />Your submitted KYC information has been disapproved, we sincerely apologize for the inconvinience, kindly find reason for dissaproval on your dashboard and you can try again.<br /><br />If you hadn\'t initiated this event, kindly disregard or send an email to angels@orkt.one<br /><br />Salute!',
        ]);
    ...
    public function approveKyc($id)
    {
        ...
        @email([
            ...
            'message' => 'Salute Ninja,<br /><br />Your submitted KYC information has been approved, kindly go ahead to carry out any transactions.<br /><br />If you hadn\'t initiated this event, kindly disregard or send an email to angels@orkt.one<br /><br />Salute!',
        ]);
