...
class AdminController extends Controller
{
   public function __construct()
   {
    ...
    {
        return view('admin.notifications'); // response()->json(['message' => 'Notification']);
    }
    ...
    public function sendNotification()
    {
        ...
        foreach($users as $user) {
            if($user->device_token) {
                sendFirebaseNotification(request('title'), request('message'), $user->device_token, []);
            }    
        }
        
        return redirect()->back()->with('flash_msg_success','Your notification sent Successfully,');
        //return response()->json(['message' => 'SendNotification']);
    }
    // DASHBOARD
