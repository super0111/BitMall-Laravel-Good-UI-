        ...
        <div class="col-md-10 ">
            ...
            <ul class="list-group">
                @foreach ($info->kyc_info as $key => $item)
                   ...
                   <li class="list-group-item text-right">
                        @if (access('kyc reject'))
                        <button class="btn btn-danger mr-2" data-toggle="modal" data-target="#resetModal"><i class="fas fa-ban"></i> @lang('Reset')</button>
                        @endif
                   </li>
                   @endif
            ...
            <form action="{{route('admin.kyc.reject',$info->id)}}" method="POST">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">@lang('Reset KYC')</h5>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-danger">@lang('Reset')</button>
                    </div>
                </div>
            </form>
        </div>
