<aside id="sidebar-wrapper">
  ...
  <ul class="sidebar-menu mb-5">
      ...
      @if (access('transactions'))
      <li class="nav-item {{menu('admin.notifications')}}">
        <a href="{{route('admin.notifications')}}" class="nav-link"><i class="fas fa-bell"></i><span>@langg('Send Notification')</span></a>
      </li>
      @endif

      <li class="menu-header">@langg('Manage')</li>
      <li class="nav-item {{menu(['admin.user.best_seller'])}}">
        <a href="{{route('admin.user.best_seller')}}" class="nav-link"><i class="fas fa-users"></i><span>@langg('Best Sellers')</span></a>
      </li>
      ...
      <li class="nav-item {{menu('admin.review.index')}}">
        <a href="{{route('admin.review.index')}}" class="nav-link"> <i class="fas fa-th"></i><span>@langg('Reviews')</span></a>
      </li>
      ...
      @endif
      @if(access('manage page') || access('menu builder') || access('site contents') ||  access('manage blog-category') || access('seo settings'))
      <li class="nav-item dropdown {{menu(['admin.front*','admin.page*','admin.frontend*','admin.bcategory*','admin.seo-setting*'])}}">
      ...
      @if(access('manage blog'))
      <li class="nav-item dropdown {{menu(['admin.blog*'])}}">
        <a href="#" class="nav-link has-dropdown"><i class="fas fa-blog"></i> <span>@langg('Manage Blog')</span></a>
        <ul class="dropdown-menu">
        

          
          <li class="{{menu(['admin.blog.index','admin.blog.create','admin.blog.edit'])}}"><a class="nav-link" href="{{route('admin.blog.index')}}">@langg('Admin Blog')</a></li>
          <li class="{{menu('admin.blog.user*')}}"><a class="nav-link" href="{{route('admin.blog.user.index')}}">@langg('User Blog')</a></li>
