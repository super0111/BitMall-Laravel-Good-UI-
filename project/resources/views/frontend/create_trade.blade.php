...
<section class="trade-request-section pb-100 pt-100">
    <div class="container">
        <div class="row gy-4">
                    ...
                    <div class="about-offer-area border rounded">
                        ...
                        <div class="about-offer-wrap">
                            ...
                            <div class="d-flex flex-wrap">
                                ...
                                @if($offer->type == 'buy')
                                    <div class="about-offer-item">
                                        <span class="title">{{__($gs->title)}} @langg('Fee')</span>
                                        <div class="info">
                ...
                <div class="about-offer">
                    ...
                    <div class="about-offer-area border rounded">
                        <div class="cmn--media ms-0">
                            ...
                            <div class="subtitle">
                                <h5 class="m-0"><a href="{{ route('profile', ['id' => $offer->user->id]) }}"> {{$offer->user->name}} </a> </h5>
                                <span class="m-0">@langg('Total Completed Trade : ') {{$offer->user->completedTrade()}}</span>
                            </div>
                        </div>
            ...
            <div class="col-lg-6">
                <div class="about-offer">
                    <h4 class="title mb-3 pt-3">@langg('Trade Instruction')</h4>
                    <div class="about-offer-area border rounded">
...
<section class="trade-request-section pb-100 pt-100">
    <div class="container">
        <div class="row gy-4">
            <div class="col-lg-12">
                <div class="create-trade-request-wrapper  border">
                <h6 class="text-center">@langg('Please submit your KYC info for further trade.') <a class="text--base" href="{{route('user.kyc.form')}}">@langg('Submit.')</a></h6>
                </div>
            </div>
        </div>
    </div>
