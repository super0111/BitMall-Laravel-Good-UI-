    ...
    <div class="container">
        <div class="ctas__wrapper">
            ...
            <div class="ctas-button">
                ...
                <h2 class="title">@langg('Register')</h2>
                <div class="text">
                   @langg('Don\'t have an account ? Register with us.')
                    </spandiv>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="footer-wrapper">
                ...
                <div class="footer-links mobile-second-item">
                    ...
                    <ul>
                        <li>
                            <a href="{{route('offer.list',['type' => 'buy'])}}">@lang('Buy Crypto')</a>
                        </li>
                        <li>
                            <a href="{{route('offer.list',['type' => 'sell'])}}">@lang('Sell Crypto')</a>
                        </li>
                        <li>
