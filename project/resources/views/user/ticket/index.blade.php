                   ...
                   <div class="card-body">
                    <div class="chatbox__list__wrapper">
                        <div class="d-flex justify-content-between py-4 border-bottom border--dark">
                            <h4 class="mt-2"><a href="javascript:void(0)">@langg('Tickets')</a></h4>
                            <button class="btn btn--base btn-sm shadow-none" data-bs-toggle="modal" data-bs-target="#modelId"><i class="fas fa-plus me-2"></i> @langg('Open a Ticket')</button>
                        </div>
