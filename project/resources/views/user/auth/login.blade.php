                ...
                <div class="accounts-left-content">
                    ...
                    <form class="row gy-4" action="{{route('user.login')}}" method="post">
                        ...
                        <div class="col-12 mt-2">
                          <a href="{{route('user.forgot.password')}}" class="text--base">@langg('Forget Password?')</a>
                        </div>
                        <div class="col-sm-12">
                            <button type="submit" class="cmn--btn">@langg('Sign In')</button>
                        </div>
                        <div class="col-sm-12">
                            @langg('Not registered yet ?') <a href="{{route('user.register')}}" class="text--base">@langg('Create an Account')</a>
                        </div>
                    </form>
                </div>
            </div>
