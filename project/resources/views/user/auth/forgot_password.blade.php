            ...
            <div class="accounts-left">
                <div class="accounts-left-content">
                    ...
                    <div class="section-header">
                        ...
                        <p>
                            @langg('Enter your email address and a verification code will be sent to your email.')
                        </p>
                    </div>
                    <form class="row gy-4" action="" method="post">
                        ...
                        <div class="col-sm-12 form-group">
                            ...
                            <input type="email" name="email" class="form-control" id="email" placeholder="@langg('Email Address')" value="{{old('email')}}" required>
                        </div>
                        <div class="col-sm-12">
