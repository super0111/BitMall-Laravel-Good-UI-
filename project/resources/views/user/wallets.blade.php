                ...
                <div class="dashboard-card">
                    ...
                    <div class="dashboard-card__content">
                        <div class="deposit-btn-grp">
                            ...
                            <a href="javascript:void(0)" data-code="{{$item->curr->code}}" data-charge="{{@$item->curr->charges->deposit_charge}}" class="btn btn-sm btn--primary deposit">@langg('Get Deposit Address')</a>

                            <a href="{{route('user.deposit.address.existing',$item->curr->code)}}" class="btn btn-sm btn--info btn-block">@langg('Existing Addresses')</a>
                            @endif
...
@push('script')
    <script>
        ...
        $('.deposit').on('click', function () { 
            ...
            $('.charge').text($(this).data('charge')+'% '+'@langg(' deposit charge will be reduced from the amount.')')
