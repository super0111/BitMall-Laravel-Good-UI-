...
@section('breadcrumb')
 <section class="section">
    <div class="section-header  d-flex justify-content-between">
        ...
        <a href="{{route('user.blog.index')}}" class="btn btn-primary"><i class="fas fa-backward"></i> @langg('Back')</a>
    </div>
</section>
@endsection
@section('content')
   ...
   <div class="col-md-12">
      ...
      <div class="card mb-4">
         ...
         <div class="card-body">
            ...
            <form action="{{route('user.blog.store')}}" enctype="multipart/form-data" method="POST">
                @csrf
                <div class="col-md-12 ShowImage mb-3  text-center">
                    <img src="{{ getPhoto('') }}" id="img" class="img-fluid" alt="image" width="400">
                 </div>
