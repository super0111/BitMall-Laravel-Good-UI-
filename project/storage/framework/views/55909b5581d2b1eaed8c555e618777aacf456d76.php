...
<?php endif; ?>
<li class="list-group-item d-flex justify-content-between"><?php echo translate('Date'); ?><span><?php echo e(dateFormat($transaction->created_at,'d M y')); ?></span></li><?php /**PATH E:\james-backup\admin\project\resources\views/user/trx_details.blade.php ENDPATH**/ ?>